  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li @if( url()->current() == url('/donations')) class="active" @endif><a href="{{ url('/donations') }}"><i class="fa fa-book"></i> <span>Donations</span></a></li>
        <li @if( url()->current() == url('/families')) class="active" @endif><a href="{{ url('/families') }}"><i class="fa fa-book"></i> <span>Families</span></a></li>
        ...
        <li @if( url()->current() == url('/volunteers')) class="active" @endif><a href="{{ url('/volunteers') }}"><i class="fa fa-book"></i> <span>Volunteers</span></a></li>

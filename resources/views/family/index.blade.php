    ...
    <family-component inline-template>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-11">
                    <div class="card">
                        <button v-if="!showFamilyForm" type="button" class="btn btn-primary pull-right"
                                @click="toggoleFamilyForm()">
                            Add Families
                        </button>
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <tr v-for="family in families.data">
                                            <td v-if="family.contact_history" style="color: red; font-weight: bold;"
                                                v-text="family.name"></td>
                                            ...
                                            <td>
                                                <button style="margin-bottom: 5px" @click="EditFamily(family)"
                                                        class="btn btn-warning"><i class="fa fa-edit"></i></button>
                                                <button style="margin-bottom: 5px" @click="deleteFamily(family.id)"
